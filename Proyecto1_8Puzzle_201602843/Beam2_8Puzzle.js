...
function puzzle() {
	var nodes = prompt("Ingrese los valores del 8 puzzle, seguido del tipo de euristica separado por un guión, donde el 1 para casillas fuera de lugar y 2 para manhattan.\nEl 0 representa el vacío. \nEjemplo: 203156478-2")
	if (nodes == null || nodes == '') nodes = '827136054-2';
	nodes = nodes.split('-')
